...
const HeroSection = () => {
  ...
  return (
    <div className="pt-15" ref={container}>
      <div className='relative overflow-hidden wrapper'>
        <div className='max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10'>
          {/* Announcement Banner */}
          <div className='flex justify-center pb-15'>
            <Link
              className='inline-flex items-center gap-x-2 bg-neutral-800 border border-neutral-700 text-xs text-slate-100 p-2 px-3 rounded-full transition hover:border-neutral-600 focus:outline-hidden focus:border-neutral-600'
              to='/work'
            >
          ...
          <div className='mt-5 max-w-xl text-center mx-auto'>
            <h1 className='text-gs block font-bold text-slate-100 text-4xl md:text-5xl lg:text-6xl'>
              <span className='text-blue-600 animate-pulse'>{t('hero.greeting')}</span> {t('hero.name_line')}
            </h1>

            <h2 className=' text-gs2 mt-4 block font-bold text-slate-100 text-3xl md:text-4xl lg:text-5xl min-h-[60px]'>
              I'm{" "}
          ...
          {/* Buttons */}
          <div className=' mt-15 gap-3 flex justify-center'>
            <a
